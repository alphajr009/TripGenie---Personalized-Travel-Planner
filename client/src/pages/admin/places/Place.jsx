...
function Place() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, places) => (
        <button
          className="btn-delete-places-by-seller"
          onClick={() => {
            Swal.fire({
              title: "Are you sure?",
    ...
    <div className="seller-central-places">
      <div className="seller-central-places-container">
        <div className="seller-central-places-tab">
          <div
            className={`seller-central-create-blog-tab-container ${
              activeTab === "create blog" ? "active" : ""
            }`}
            onClick={() => setActiveTab("create blog")}
          >
            <span className="seller-central-tab-text-create-blog">
              Create Place
            </span>
          </div>

          <div
            className={`seller-central-places-tab-container ${
        ...
        {activeTab === "blog" && (
          <div className="seller-central-table-places-sellers">
            <Table
              ...
              rowKey="_id"
              footer={() => (
                <div className="no-of-places">{`Total  ${places.length} places `}</div>
              )}
            />
          </div>
        )}
